...
public class PivotRotation : MonoBehaviour
{
    ...
    private void SpinSide(List<GameObject> side, int rotateDirection)
    {
        ...
        {
            rotation.y = /*(mouseOffset.x + mouseOffset.y) * sensitivity * 1*/ rotateDirection * 90;
        }
        ...
        {
            rotation.z = /*(mouseOffset.x + mouseOffset.y) * sensitivity * 1*/ rotateDirection * 90;
        }
        ...
        {
            rotation.x = /*(mouseOffset.x + mouseOffset.y) * sensitivity * -1*/ rotateDirection * 90;
        }
        if (side == cubeState.back)
        {
            rotation.x = /*(mouseOffset.x + mouseOffset.y) * sensitivity * 1*/ rotateDirection * 90;
        }
        if (side == cubeState.centerHorizontal)
        {
            rotation.y = rotateDirection * 90;
        }
        if (side == cubeState.centerVertical)
        {
